...
from libs.utils               import get_constraints, feasibility
...
# Q 11.6
eqConstraints   = [ lambda x: x[0] + 2*x[1] + x[2] + 2*x[3] - 3,
...
constraintList = get_constraints(eqConstraints, ineqConstraints)
