...
#
# plt.clf()
# # plot_line_search(alphaList, initialX, initialDir, func4,fig_name="Line_search_plot_ILS", save=False, show=True)
...
plt.clf()
initialAlpha = 1
plot_line_search(alphaList, initialAlpha, initialX, initialDir, func4, fig_name="Line_search_plot_BT", save=False, show=True)
